...
const ICONS = {
  ...
  services:     "M3 3h2l.4 2M7 13h10l4-8H5.4M7 13L5.4 5M7 13l-2.293 2.293c-.63.63-.184 1.707.707 1.707H17m0 0a2 2 0 100 4 2 2 0 000-4zm-8 2a2 2 0 11-4 0 2 2 0 014 0z",
  seminars:     "M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z",
  imvunulo:     "M4 4l4 4M20 4l-4 4M4 20l4-4M20 20l-4-4M8 8h8v8H8z",
      ...
      <aside className="sticky top-0 h-screen flex flex-col overflow-y-auto flex-shrink-0"
        ...
        <nav className="flex-1 px-3 py-4 space-y-0.5">
          ...
          {[
            ...
            { to: "/practitioner/services",      label: "My Services",   icon: "services"      },
            { to: "/practitioner/seminars",       label: "Seminars",      icon: "seminars"      },
            { to: "/practitioner/imvunulo",       label: "Imvunulo Listings", icon: "imvunulo"  },
            { to: "/practitioner/library",        label: "Publications",  icon: "library"       },
            { to: "/practitioner/notifications", label: "Reviews & Enquiries", icon: "notifications", badge: notifCount },
