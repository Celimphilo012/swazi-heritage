...
const ICONS = {
  ...
  tourism:   "M17.657 16.657L13.414 20.9a2 2 0 01-2.828 0l-4.243-4.243a8 8 0 1111.314 0z",
...
const NAV_ITEMS = [
  ...
  { to: "/admin/tourism",             label: "Tourism",         icon: "tourism"   },
  { to: "/admin/analytics",           label: "Analytics",       icon: "analytics" },
  { to: "/admin/ratings",             label: "Ratings",         icon: "ratings"   },
