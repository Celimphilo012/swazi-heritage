    ...
    <div className="p-6 space-y-6">
      ...
      <div className="relative rounded-2xl overflow-hidden px-6 py-6 flex items-center justify-between gap-4"
        ...
        <div className="relative z-10 flex-shrink-0 opacity-90">
          <svg width="48" height="60" viewBox="0 0 80 100" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <clipPath id="overview-shield-clip">
              <path d="M40,5 C56,5 68,18 68,40 C68,64 56,88 40,100 C24,88 12,64 12,40 C12,18 24,5 40,5Z"/>
            </clipPath>
            <rect x="12" y="5" width="28" height="95" fill="#ddd" clipPath="url(#overview-shield-clip)"/>
